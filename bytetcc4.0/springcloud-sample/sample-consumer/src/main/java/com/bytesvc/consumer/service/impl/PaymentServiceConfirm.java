 ...
 * @author xiaoyu
 */
@Service("paymentServiceConfirm")
@SuppressWarnings("all")
public class PaymentServiceConfirm implements PaymentService {

    /**
     * logger.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(PaymentServiceConfirm.class);
    ...
    public PaymentServiceConfirm(OrderMapper orderMapper,
