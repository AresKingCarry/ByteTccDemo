...
package com.bytesvc.provider.mapper;
...
public interface InventoryMapper {
     ...
     * @return rows
     */
    @Update("update inventory set total_inventory = total_inventory - #{exchangeInventory}," +
            " lock_inventory= lock_inventory + #{exchangeInventory}" +
